...
module.exports.index = async (req, res) => {
  ...
  // res.render("./listings/index.ejs", { allListings }); varche juni ahe fkt ejs kadaych======================
...
module.exports.showListing = async (req, res) => {
  ...
  if (!listing) {
    ...
    return res.redirect("/listings"); //return new added===================
  }
  console.log(listing);
...
module.exports.renderEditForm = async (req, res) => {
  ...
  res.render("listings/edit", { listing, originalImageUrl }); // ✅ fixed
};
